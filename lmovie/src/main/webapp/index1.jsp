    ...
    <div class="movie-content clearfix">
	 ...
	 --%>
									...
									<div id="pagerContainer">
										<div class="mod-page">
											<a href="javascript:void(0)" onclick="toPage(1)">首页</a> <a
												...
												onclick="toPage(${bean.nowPage-1})">上一页</a> <a
												href="javascript:void(0)"
												onclick="toPage(${bean.nowPage+1})">下一页</a> <a
												href="javascript:void(0)"
												onclick="toPage(${bean.totalPage})">尾页</a>
		...
		function toPage(nowPage)
		{
			...
			window.location = "${pageContext.servletContext.contextPath }/findhit?nowPage="+nowPage;
		}
</script>
