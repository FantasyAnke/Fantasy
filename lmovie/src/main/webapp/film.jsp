...
<link rel="stylesheet" href="index1/lib.css"><link rel="stylesheet" href="index1/ui.css"><link rel="stylesheet" href="index1/dialog_f5e2c3d.css"><link rel="stylesheet" href="index1/movielist.css"><link rel="stylesheet" href="index1/pager_a7cdf14.css"><link rel="stylesheet" href="index1/ranklist_778b93f.css"></head>
...
<div class="widget-movie-topnav clearfix" id="widgetMovieTopnav">
     <a class="item "  data-type="hot"  data-url="${pageContext.servletContext.contextPath }/findhit" data-log="{'da_src':'webMovieListPg.navBk.hotLnk'}" href="javascript:;">热映影片</a>
    <a class="item "   data-type="new"  data-url="${pageContext.servletContext.contextPath }/findmovie2" data-log="{'da_src':'webMovieListPg.navBk.newLnk'}" href="javascript:;">即将上映</a>
    <a class="item active"  data-type="lib"   data-url="${pageContext.servletContext.contextPath }/findmovie3" data-log="{'da_src':'webMovieListPg.navBk.libLnk'}" href="javascript:;">影片库</a>
   ...
   <!--  <h6 class="time nuomi-red">7月27号&nbsp;周五</h6> -->
    <div class="movie-content clearfix">
        <div class="movie-info">
            <a class="movie-pic" href="javascript:;" data-url="/movie/detail" data-data="{&quot;movieId&quot;:95452}" data-log="{'da_src':webMovieListPg.movieBk.movieHotLnk}">
                
                <img src="${pageContext.servletContext.contextPath }/img/${l.url }" alt="西虹市首富"> 
            </a>
            <div class="movie-detail">
                <p class="movie-name" data-url="/movie/detail" data-data="{&quot;movieId&quot;:95452}" data-log="{'da_src':webMovieListPg.movieBk.movieHotLnk}">
                    ${l.movieDBName }
                ...
                <div class="score">
                    <span class="star"><em style="width:84.24000000000001px;"></em></span>
                    <span class="num nuomi-red">8.1</span>
                </div>
        ...
        <div class="btns fr">
  			 <a class="btn tg" href="${pageContext.servletContext.contextPath }/chooseticket?movieDBId=${l.movieDBId}"  title="选座购票" data-log="{'da_src':'webMovieListPg.movieBk.buyBtn'}">选座购票</a>
...
<div id="pagerInfo" data-pagesize="10" data-total="31" data-pagecount="4"></div>

</div>
</div>

<div id="pagerContainer"><div class="mod-page">

	<a href="javascript:void(0)" onclick="toPage(1)">首页</a>
	<a href="javascript:void(0)" onclick="toPage(${bean.nowPage-1})">上一页</a>
	<a href="javascript:void(0)" onclick="toPage(${bean.nowPage+1})">下一页</a>
	<a href="javascript:void(0)" onclick="toPage(${bean.totalPage})">尾页</a>
...
<img id="statImgNew" style="display:none" src="index1/transparent.gif"></div>
<script type="text/javascript">
	...
	function toPage(nowPage)
	{
		...
		window.location = "${pageContext.servletContext.contextPath }/findmovie3?nowPage="+nowPage;
	}
</script>


<script type="text/javascript" src="index1/lib.js"></script><script type="text/javascript" src="index1/http_07a1657.js"></script><script type="text/javascript" src="index1/cookie_f4c070a.js"></script><script type="text/javascript" src="index1/util.js"></script><script type="text/javascript" src="index1/bdTemplate_28b34e7.js"></script><script type="text/javascript" src="index1/main_ed5455d.js"></script><script type="text/javascript" src="index1/Dialog_a99a6d7.js"></script><script type="text/javascript" src="index1/dialog_3a6ceae.js"></script><script type="text/javascript" src="index1/ui.js"></script><script type="text/javascript" src="index1/Pagination_2ff14ea.js"></script><script type="text/javascript" src="index1/pager_65de8b7.js"></script><script type="text/javascript" src="index1/movielist.js"></script><script type="text/javascript" src="index1/ranklist_bf09e32.js"></script><script type="text/javascript">!function() {
...
<a href="javascript:;" class="widget-common-backup backup-btn" id="widgetCommonBackup" style="bottom: 40px; right: 100px;">    <span class="arrow"></span>    <em class="arrow-in"></em></a></body></html>