...
<div class="city-area fl" id="cityArea">
    <!-- 显示当前城市 -->
    <p class="selected font-grey clearfix"><span id="selectedCity">郑州</span><span class="arrow"></span></p>
    ...
    <div class="content-center">
        <div class="fr user-info" id="userInfo">
            <span class="username fr font-grey font14 clearfix" id="userName" data-url="/user">
                <img class="avatar fl hide" src="ticket/f3b4334d.jpg">
                <em class="name fl"></em>
            </span>
        ...
        <div class="list clearfix">
           ...
           <!--  <a class="nav active" href="javascript:;" data-log="{'da_src':'menuBk.cinemaLnk'}" data-url="/cinema">影院</a>
...
<script type="text/javascript" src="ticket/uni_login_wrapper.js"></script>
...
<script id="mapScript" src="ticket/getscript"></script>
<script type="text/javascript" src="ticket/SearchInfoWindow_min.js"></script>
<link rel="stylesheet" href="ticket/SearchInfoWindow_min.css">
...
<div class="widget-cinema-cinemadetail-intro clearfix" id="cinemaIntro">
    ...
    <c:forEach items="${address }" var="add"> 
        ...
        <div class="left-area">
            <h2 class="title font-color">${add.movieName }
            <em class="star">
           	 <i class="star-in" style="width: 33.6px;"> </i></em>
           <!--  <em class="record font12 nuomi-red">4.2</em> -->
            </h2>
            <p class="addr font-grey">${add.movieAddress }
            <em class="line"></em>${add.moviePhone }</p>
...
<div class="widget-cinema-cinemadetail-movielist" id="cinemaMovielist">
    ...
    <div id="datelist">	
        <div class="date active hide" data-movieid="95611">
            <div class="datelist">
            
                <span data-id="1534089600000" class="active hide" data-log="{'da_src':'webCinemaDetailPg.movielistBk.dateBtn'}">
                 ${df }
                 </span>
            </div>
            <div class="session-list active hide" data-id="1534089600000">
                <ul>
                	<c:forEach items="${hall }" var="h">
                		<li class="clearfix">
                             <div class="time fl">
                                 <p class="start">
                                 <fmt:formatDate value="${h.msBeginTime }" var="date" pattern="HH:mm:ss"/>${date} 
                                </p>
                                 <p class="end"> 
                                 <fmt:formatDate value="${h.msEndTime }" var="date" pattern="HH:mm:ss"/>${date} 
                                 </p>
                             </div>
                             <div class="type fl font14">
                                 2D
                             </div>
                             <div class="hall fl font14"> ${h.mhName} </div>
                             <div class="price fl">
                                 <p><span class="dollar nuomi-red">￥</span><span class="num nuomi-red">${h.filmprice}</span>
                                     <!-- 折扣价 -->
                                     <%-- <del class="font-shadow">${h.filmprice}</del> --%>
                                 </p>
                             </div>
                             <!-- <div class="seat fl">余位98%</div> -->
   <a href="${pageContext.servletContext.contextPath }/choose.jsp" data-url="/buy/seat" data-data="{&quot;movieId&quot;:95611,&quot;cinemaId&quot;:8586,&quot;seqNo&quot;:&quot;76505948&quot;,&quot;date&quot;:1534089600000}" class="btn-select fr border-red nuomi-red font16" data-log="{'da_src':'webCinemaDetailPg.movielistBk.buyBtn'}">选座购票111</a>
              		 	</li>   
					</c:forEach>
...
<img id="statImgNew" style="display:none" src="//movielog.baidu.com/img/transparent.gif?t=1534136781645&amp;resid=31&amp;from=pc&amp;da_ver=2.1.0&amp;da_trd=movie&amp;da_act=click&amp;da_src=menuBk.homeLnk&amp;da_thirdpar=&amp;da_abtest=&amp;da_subchannel=&amp;da_channel=movie&amp;da_client=pc&amp;da_module=&amp;cuid="></div>
<script type="text/javascript" src="ticket/lib.js"></script><script type="text/javascript" src="ticket/flexslider_f4a305d.js"></script><script type="text/javascript" src="ticket/http_07a1657.js"></script><script type="text/javascript" src="ticket/cookie_f4c070a.js"></script><script type="text/javascript" src="ticket/util.js"></script><script type="text/javascript" src="ticket/bdTemplate_28b34e7.js"></script><script type="text/javascript" src="ticket/main_ed5455d.js"></script><script type="text/javascript" src="ticket/Dialog_a99a6d7.js"></script><script type="text/javascript" src="ticket/dialog_3a6ceae.js"></script><script type="text/javascript" src="ticket/ui.js"></script><script type="text/javascript" src="ticket/map_929d2e9.js"></script><script type="text/javascript">!function() {

window._commonData = {"location":{"cityId":268,"cityName":"郑州"},"user":{"userid":1295234291,"username":"","displayname":"14...4@qq.com","status":true,"avatar":"http://himg.baidu.com/sys/portrait/item/f3b4334d"},"https":false};
...
!function() {
require("common:widget/menu/menu.js").init({"location":{"cityId":268,"cityName":"郑州"},"user":{"userid":1295234291,"username":"","displayname":"14...4@qq.com","status":true,"avatar":"http://himg.baidu.com/sys/portrait/item/f3b4334d"},"https":false});
}();
!function() {
require('common:widget/ui/map/map.js');
}();
!function() {

window.addStat({
    da_src:'webCinemaDetailPg',
    da_act:'ready'
});
