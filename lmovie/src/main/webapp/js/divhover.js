...
(function($){
	$.fn.num = function(options){
		...
		function num1(){
			...
			function num2(){
				// top边框
				var divTop = "<div style='"+becurr+"height:2px;width:233px;top:-2px;left:-80px;' class='divTop'></div";
	
				// right边框
				var divRight = "<div style='"+becurr+"height:156px;width:2px;top:-80px;right:-2px;' class='divRight'></div";
	
				// Bottom边框
				var divBottom = "<div style='"+becurr+"height:2px;width:233px;bottom:-2px;right:-80px;' class='divBottom'></div";
	
				// Left边框
				var divLeft = "<div style='"+becurr+"height:156px;width:2px;bottom:-80px;left:-2px;' class='divLeft'></div";
				_this.hover(function(){
					el = $(this)
					el.append(divTop,divRight,divBottom,divLeft);
					num2 = new than(el)
